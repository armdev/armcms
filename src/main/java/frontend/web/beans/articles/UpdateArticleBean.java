...
@ManagedBean(name = "UpdateArticleBean")
@ViewScoped
public class UpdateArticleBean implements Serializable {
    ...
    public void init() {
        ...
        if (ex != null && ex.getRequestParameterMap() != null && ex.getRequestParameterMap().containsKey("next")) {
            articleId = Util.longValue(ex.getRequestParameterMap().get("next"));
        }
        if (articleId == null) {   
            redirectBack();
        }
        if (articleId != null) {
            articleEntity = articleManagerFacade.getArticleById(articleId);
        }
    ...
    public void redirectBack() {
        ...
        nav.handleNavigation(context, null, "articleslist");
    ...
    public String delete() {
        if (articleId != null) {
            articleManagerFacade.removeArticle(articleId);
        }
        return "articleList";
    }
    ...
    public String updateArticle() {
        ...
        articleManagerFacade.updateArticle(articleEntity);
        return "articleslist";
    }
