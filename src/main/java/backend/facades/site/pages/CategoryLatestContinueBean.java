 ...
 */
@ManagedBean(name = "CategoryLatestContinueBean")
@ViewScoped
public class CategoryLatestContinueBean  implements Serializable {
    ...
    public CategoryLatestContinueBean() {
    ...
    public void init() {
        ...
        if (categoryId != null) {
            moreList = this.getLatestArticleList(categoryId);
